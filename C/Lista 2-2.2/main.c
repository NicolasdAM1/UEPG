...
//Lista 2:
 ...
 //Para representar um n�mero em ponto flutuante, o correto � usar "%f".
...
getch();
 ...
 /*Ex.: 10
  int D, M, A;
  printf("DIGITE UMA DATA, PRESSIONE 'ENTER', UM M�S, PRESSIONE 'ENTER' E POR �LTIMO UM ANO E PRESSIONE 'ENTER'.\n");
  scanf("%d",&D);
  scanf("%d",&M);
  scanf("%d",&A);
  printf("%d\\%d\\%d",D,M,A);*/
 ...
 /*Ex.: 11
  printf("Valor da constante: %f",E);*/

 /*Ex.: 12
  const int a = 15;
  printf("Valor da constante: %d",a);*/
